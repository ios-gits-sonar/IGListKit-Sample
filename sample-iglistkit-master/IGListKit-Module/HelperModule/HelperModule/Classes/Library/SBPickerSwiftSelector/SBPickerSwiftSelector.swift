...
public class SBPickerSwiftSelector: UIViewController {
    ...
    fileprivate var setAction: ((_ values: [Any], _ index: Int?)->())?
    ...
    @IBAction fileprivate func doneAction(_ sender: Any) {
        ...
        case .text:
            ...
            setAction?(values, index)
        
        case .dateDefault, .dateDayMonthYear, .dateHour:
            setAction?([datePickerView.date], nil)
    ...
    public func set(_ action: @escaping (_ values: [Any], _ index: Int?)->()) -> SBPickerSwiftSelector {
        setAction = action
        return self
    }
...
extension SBPickerSwiftSelector {
    static var bundle:Bundle {
        let podBundle = Bundle(for: SBPickerSwiftSelector.self)
    ...
    public convenience init(mode: Mode, data: [Any]? = nil, startDate: Date? = nil, endDate: Date? = nil, defaultDate: Date? = nil, componentForSelectedRows: [Int: Int]? = nil) {
        self.init(nibName: "SBPickerSwiftSelector", bundle: SBPickerSwiftSelector.bundle)
